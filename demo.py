...
DEMO_SCENARIOS = [
    {
        ...
        "chat_history": [
            ...
            {
                "role": "assistant",
                "content": "Of course! What topic are you working on?",
            },
        ],
    ...
    },
    {
        ...
        "chat_history": [
            ...
            {
                "role": "assistant",
                "content": "That's an important topic! What specifically are you having trouble with?",
            },
        ],
...
class DemoRunner:
    ...
    def __init__(self):
        ...
        self.parameter_extractor = ParameterExtractor(
            model_name="gpt-4o-mini", temperature=0.1  # Using more accessible model
        )
        self.orchestrator = AITutorOrchestrator(
            parameter_extractor=self.parameter_extractor, tool_client=self.tool_client
        )
        ...
        try:
            ...
            if response.tool_response and response.success:
                ...
                if response.tool_used == "flashcard_generator":
                    ...
                    if flashcards:
                        print(
                            f"   Sample: {flashcards[0].get('question', 'N/A')[:60]}..."
                        )
